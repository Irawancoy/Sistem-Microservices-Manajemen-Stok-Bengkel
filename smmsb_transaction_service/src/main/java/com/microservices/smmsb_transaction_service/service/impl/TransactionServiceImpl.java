...
public MessageResponse createTransaction(CreateTransactionRequest createTransactionRequest) {
    ...
    String inventoryUrl = "http://localhost:8080/api/v1/product-stock/get-by-id/" + createTransactionRequest.getProductId();
    ...
    UpdateProductStockEvent event = new UpdateProductStockEvent(transaction.getProductId(), transaction.getQuantity());
